...
public class Q3EMain extends Activity
{
    ...
    private final Runnable splashWatcher = new Runnable() {
        ...
        public void run()
        {
            ...
            long elapsed = System.currentTimeMillis() - splashShownAtMs;
            if (Q3E.callbackObj != null && !Q3E.callbackObj.inLoading && elapsed >= 1500L)
            {
        ...
        public void onAudioFocusChange(int focusChange)
        {
            switch (focusChange)
            {
                ...
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK:
                    // Screen recording and other short-lived system audio actions can trigger
                    // transient focus changes. Keep the game audio running instead of pausing.
                    break;
                case AudioManager.AUDIOFOCUS_GAIN:
                    if (m_pausedByAudioFocus)
                    {
                        Q3E.Resume();
                        if (Q3E.callbackObj != null)
                            Q3E.callbackObj.resume();
                        m_pausedByAudioFocus = false;
                    }
                    break;
            }
        }
    ...
    protected void onDestroy()
    {
        ...
        Q3E.Stop();
        handler.removeCallbacks(splashWatcher);
...
/*        if (null != mGLSurfaceView)
    ...
    protected void onResume()
    {
        ...
        if(m_runBackground < 2 || mAudioManager == null)
        ...
        if(Q3E.callbackObj != null && m_runBackground < 2)
        {
            Q3E.callbackObj.resume();
        }
    }
...
/*        if(m_hideNav)
    ...
    private void InitProps()
    {
        ...
        String harm_run_background = preferences.getString(Q3EPreference.RUN_BACKGROUND, "2");
    ...
    private void SetupSplashOverlay()
    {
        ...
        splashView.setImageResource(R.drawable.luna_splash);
        splashView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        splashView.setBackgroundColor(0xFF000000);
        splashShownAtMs = System.currentTimeMillis();
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT
        );
        mainLayout.addView(splashView, params);
        Q3EUtils.SetViewZ(splashView, TOOLBAR_Z + 10);
        handler.post(splashWatcher);
    }
